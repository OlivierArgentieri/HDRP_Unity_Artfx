...
[CustomEditor(typeof(CM_CurveManager))]
public class CM_CurveManagerEditor : EditorCustom<CM_CurveManager>
{
    ...
    private void UIAgent()
    {
        ...
        {
            CM_Agent _agent = eTarget.Agents[i];
    ...
    private void UISegment(CM_Curve _curve)
    {
